...
exports.NODE_DIMENSIONS = void 0;
exports.inferNodeType = inferNodeType;
exports.resolveNodeStyle = resolveNodeStyle;
exports.resolveEdgeStyle = resolveEdgeStyle;
// ============================================================
// Default node dimensions by type
// ============================================================
exports.NODE_DIMENSIONS = {
...
const BASE_STYLES = {
    ...
    process: 'rounded=0;whiteSpace=wrap;html=1;fontSize=12;fontFamily=Helvetica;',
    // Action nodes - rounded rectangle, blue
    action: 'rounded=1;whiteSpace=wrap;html=1;fillColor=#dae8fc;strokeColor=#6c8ebf;fontSize=12;fontFamily=Helvetica;',
    // Decision - diamond
    decision: 'rhombus;whiteSpace=wrap;html=1;fontSize=12;fontFamily=Helvetica;',
    // Start / entry - rounded, green
    start: 'rounded=1;whiteSpace=wrap;html=1;fillColor=#d5e8d4;strokeColor=#82b366;fontSize=12;fontFamily=Helvetica;fontStyle=1;',
    // End / return - ellipse
    end: 'ellipse;whiteSpace=wrap;html=1;fontSize=12;fontFamily=Helvetica;',
    // Note / important annotation - note shape, yellow
    note: 'shape=note;whiteSpace=wrap;html=1;fillColor=#ffffc0;strokeColor=#d6b656;fontSize=11;fontFamily=Helvetica;',
    // Async / MQ / Consumer / Task - dashed gray rectangle
    async: 'rounded=0;whiteSpace=wrap;html=1;dashed=1;fillColor=#f5f5f5;strokeColor=#666666;fontColor=#333333;fontSize=12;fontFamily=Helvetica;',
    // Group / swimlane container
    group: 'swimlane;startSize=30;fontSize=13;fontStyle=1;fillColor=#f5f5f5;strokeColor=#666666;',
};
// ============================================================
// Edge style strings
// ============================================================
const EDGE_STYLES = {
    default: 'edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;exitX=0.5;exitY=1;exitDx=0;exitDy=0;',
    dashed: 'edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;dashed=1;',
    async: 'edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;dashed=1;endArrow=open;strokeColor=#666666;',
    thick: 'edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;strokeWidth=2;',
};
const KEYWORD_RULES = [
 ...
 */
function resolveNodeStyle(type, overrides) {
 ...
 */
function resolveEdgeStyle(style = 'default') {
